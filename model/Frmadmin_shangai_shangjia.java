...
public class Frmadmin_shangai_shangjia extends JFrame implements ActionListener{
	...
	public Frmadmin_shangai_shangjia() {
		...
		JLabel lblNewLabel = new JLabel("输入要删改的商家号：");
		...
		JLabel lblNewLabel_3 = new JLabel("商家姓名：");
		...
		JLabel lblNewLabel_4 = new JLabel("商家星级：");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnNewButton) {
			try {
				ttcpUtil.adminshangjiaguanli.deleteshangjia(Integer.valueOf(this.textField.getText()));
			...
			try {
				ttcpUtil.adminshangjiaguanli.xiugaishangjia(Integer.valueOf(this.textField.getText()), this.textField_1.getText(), Integer.valueOf(this.textField_2.getText()), Float.parseFloat(this.textField_3.getText()));
			} catch (NumberFormatException | BaseException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}

...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		button.setBounds(14, 175, 97, 35);
		contentPane.add(button);
		button.addActionListener(this);

		button_1.setBounds(130, 175, 112, 35);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource() == this.button) {
			try {
				ttcpUtil.adminshangjiaguanli.addshagnjia(this.textField_1.getText(), Integer.valueOf(this.textField_2.getText()),Float.parseFloat(this.textField_3.getText()));

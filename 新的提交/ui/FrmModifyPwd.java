...
public class FrmModifyPwd extends JDialog implements ActionListener {
	...
	private JLabel labwlPwdOld = new JLabel("原密码：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				ttcpUtil.userManager.changeuserPwd(Beanuser.currentLoginUser,String.valueOf(edtPwdOld.getPassword()),String.valueOf(edtPwd.getPassword()),String.valueOf(edtPwd2.getPassword()));									
				this.setVisible(false);
